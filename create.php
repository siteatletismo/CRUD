...
<title> Leitor de usuários </title>
...
// posted values
	$nome 		= htmlspecialchars(strip_tags($_POST['nome_usuario']));
...
$data_criacao = date('Y-m-d H:i:s'); $stmt->bindParam(':data_criacao', $data_criacao);
// Execute the query
if($stmt->execute()){
